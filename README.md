...
We propose a hybrid GCN–SAGE–Residual graph neural network that predicts the complete element-wise Cauchy stress tensor on patient-specific finite element (FE) meshes of the proximal femur, as a fast surrogate for computationally expensive FE simulations used in osteoporotic hip fracture risk assessment.
